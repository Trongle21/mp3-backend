...
// Đặt TRƯỚC middleware DB để vẫn truy cập được khi DB lỗi.
...
// Đảm bảo MongoDB đã kết nối trước MỌI route /api/* (kể cả auth middleware,
// controllers, v.v.). Phải đặt TRƯỚC app.use("/api/...").
